...
const Navigation = () => {
  ...
  return (
    <div className='h-screen sticky top-0'>
      ...
      {/* Post Button */}
      <div className='py-6'>
        <button className='w-full rounded-[25px] py-3 bg-[#1e88e5] text-white hover:bg-[#1565c0] text-base'>
          Post
        </button>
      </div>
      ...
      {/* Modal */}
      {isModalOpen && (
        <div className='absolute bottom-12 right-0 bg-gray-800 shadow-md rounded-lg px-4 py-3 w-52 relative'>
